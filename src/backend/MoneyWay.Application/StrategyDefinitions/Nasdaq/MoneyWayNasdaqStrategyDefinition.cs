    ...
    public static StrategyDefinition Instance { get; } = new(
        ...
        [
            ...
            Rule("NQ-H4-001", "4H-first context", "4H", 10, true, RuleDefinitionStatus.Confirmed,
                "At 08:00 America/Bogota, use the formally closed 4H candle to review HH/HL bullish or LL/LH bearish context, classify Breakout, Wickfill, or Fakeout using OR, and determine the permitted direction. Candidate-HL selection is partially defined: within a human-delimited correction, preliminary or intermediate lows are discarded and the deepest low that forms the base of the impulse later producing a body close above the prior HH is the candidate; one- or two-candle pauses inside that impulse do not create another HL. Within the selected turn, its structural reference is the lowest Open or Close among its candle bodies, not an isolated wick. The candidate becomes a validated HL retrospectively only from that causal closed-body break AsOfUtc. Candidate-LH selection remains unresolved; a supplied candidate high becomes a validated LH only when its impulse produces a body close below the prior LL. A new HH or LL likewise requires a formally closed candle body beyond the prior structural extreme; wick-only penetration and an open candle do not confirm structure. Initial structural candidate/bootstrap selection, reproducible correction and turn segmentation, equal-coordinate body tie-breaking, candidate-LH selection, and exact structural coordinates remain visual/contextual rather than a deterministic raw-candle algorithm."),
            ...
            Rule("NQ-LIQ-002", "Relevant liquidity", "Liquidity", 60, true, RuleDefinitionStatus.HumanValidationRequired,
                "At Step 2, mark Asia and London highs/lows together with human-selected relevant structural 1H/4H liquidity references. When a relevant session target is no longer future-valid before the operational setup context, structural fallback is partially defined: for a sell, candidates are relevant unmitigated support represented by a validated 1H/4H HL or LL and Previous Day Low; for a buy, they are relevant unmitigated resistance represented by a validated 1H/4H LH or HH and Previous Day High. Candidate-HL selection is partially defined: within a human-delimited correction, preliminary or intermediate lows are discarded and the deepest low that forms the base of the impulse later producing a formally closed body above the prior HH is the candidate; one- or two-candle pauses inside that impulse do not create another HL. Its selected-turn reference is the lowest Open or Close among its candle bodies, not an isolated wick. It becomes validated only from that causal close AsOfUtc. Candidate-LH selection remains unresolved; a supplied candidate LH validates only after its impulse produces a formally closed body below the prior LL. New HH/LL likewise require that closed body beyond the prior structural extreme. Wick-only penetration or an open candle does not confirm structure. In reviewed paths with distinct relevant levels, 1H may act as the first target or management level and a farther 4H as the final or extended target; 4H is structurally stronger. Exact correction and turn boundaries, candle count, pivots/lookbacks, candidate-LH and other structural-point selection, equal-coordinate body tie-breaking, other exact structural coordinates, OHLC mitigation semantics, body-zone reduction, PDH/PDL ranking, ties, and any universal 1H/4H priority remain unresolved or partially defined."),
            ...
            Rule("NQ-TP-001", "Important liquidity target", "Take Profit", 210, false, RuleDefinitionStatus.HumanValidationRequired,
                "For a buy, primary session targets are London High and Asia High; for a sell, they are London Low and Asia Low. Distinct future-valid session targets use the first relevant level encountered in the expected price direction; equal Asia/London prices merge into one unique target, treated as final Take Profit in the reviewed scenario without an intermediate Break-Even event. When no relevant session target remains future-valid before the operational scenario, the structural fallback is partially defined: sell candidates include relevant unmitigated support at validated 1H/4H HL or LL and Previous Day Low; buy candidates include relevant unmitigated resistance at validated 1H/4H LH or HH and Previous Day High. Candidate-HL selection and its body anchor are partially defined: within a human-delimited correction, the candidate is the deepest low that forms the base of the impulse later causing the formally closed body break above the prior HH; preliminary or intermediate lows and one- or two-candle pauses within that impulse do not create another HL. Its selected-turn reference is the lowest Open or Close among its candle bodies, not an isolated wick, and it becomes validated only from that causal close AsOfUtc. Candidate-LH selection remains unresolved. In reviewed paths, 1H may be the first target or management level and a farther, structurally stronger 4H may be final or extended; this is not a universal hierarchy. That fallback does not rescue an originally imagined scenario after a valid post-08:30 liquidity take. Exact correction and turn boundaries, candidate-LH and other structural-point selection, exact candle/body selection beyond the selected HL turn, equal-coordinate body tie-breaking, other structural coordinates, body-zone reduction, OHLC mitigation test, PDH/PDL ranking, ties, general final-target hierarchy, and universal full-exit behavior remain unresolved or human-validated. The selected target is an absolute price level whose timeframe-independent quote touch, including wick contact in candle observations, requires no body close, candle close, or tolerance."),
