    ...
    public static StrategyDefinition Instance { get; } = new(
        ...
        [
            ...
            Rule("NQ-LIQ-003", "Liquidity take required", "Sweep", 70, true, RuleDefinitionStatus.Confirmed,
                "From the 08:30 operational start, price must exceed a selected relevant High or go below a selected relevant Low before any Step-4 5M setup is valid; level priority and lifecycle remain unresolved."),
            ...
            Rule("NQ-M5-001", "Inversion alternatives", "5M inversion", 110, true, RuleDefinitionStatus.Confirmed,
                "Only after a valid liquidity take, require 5M Structural Change or IFVG, whichever occurs first; neither alternative bypasses the separate Step-5 FVG confirmation."),
            ...
            Rule("NQ-M1-003", "Entry mechanics", "Entry", 190, false, RuleDefinitionStatus.Unresolved,
                "Entry concept becomes eligible only after mandatory Steps 1 through 6 occur in chronological order; runtime gate-status mapping, order type, timing, and slippage remain unresolved."),
