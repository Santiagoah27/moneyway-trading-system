    ...
    public static StrategyDefinition Instance { get; } = new(
        ...
        [
            ...
            Rule("NQ-H4-001", "4H-first context", "4H", 10, true, RuleDefinitionStatus.Confirmed,
                "At 08:00 America/Bogota, use the formally closed 4H candle to review HH/HL bullish or LL/LH bearish context, classify Breakout, Wickfill, or Fakeout using OR, and determine the permitted direction. A candidate low becomes a validated HL retrospectively only when its impulse produces a body close above the prior HH on this 4H structure; a candidate high becomes a validated LH only when its impulse produces a body close below the prior LL. A new HH or LL likewise requires a formally closed candle body beyond the prior structural extreme; wick-only penetration and an open candle do not confirm structure. A candidate is not confirmed before the causal close AsOfUtc. Initial structural candidate/bootstrap selection, retracement geometry, and exact body coordinate remain visual/contextual rather than a deterministic raw-candle algorithm."),
            ...
            Rule("NQ-LIQ-002", "Relevant liquidity", "Liquidity", 60, true, RuleDefinitionStatus.HumanValidationRequired,
                "At Step 2, mark Asia and London highs/lows together with human-selected relevant structural 1H/4H liquidity references. When a relevant session target is no longer future-valid before the operational setup context, structural fallback is partially defined: for a sell, candidates are relevant unmitigated support represented by a validated 1H/4H HL or LL and Previous Day Low; for a buy, they are relevant unmitigated resistance represented by a validated 1H/4H LH or HH and Previous Day High. A candidate HL/LH is validated only after its impulse produces a formally closed body beyond the prior HH/LL on the same structural timeframe; a new HH/LL also requires that closed body beyond the prior structural extreme. Wick-only penetration or an open candle does not confirm structure, and a candidate cannot be treated as validated before the causal close AsOfUtc. In reviewed paths with distinct relevant levels, 1H may act as the first target or management level and a farther 4H as the final or extended target; 4H is structurally stronger. Mark structural support/resistance using candle bodies; an isolated long wick does not define a level by itself. Initial candidate-turn detection, candle count, pivots/lookbacks, candidate geometry, OHLC mitigation semantics, exact candle/body selection, body coordinate, body-zone reduction, PDH/PDL ranking, ties, and any universal 1H/4H priority remain unresolved or partially defined."),
            ...
            Rule("NQ-TP-001", "Important liquidity target", "Take Profit", 210, false, RuleDefinitionStatus.HumanValidationRequired,
                "For a buy, primary session targets are London High and Asia High; for a sell, they are London Low and Asia Low. Distinct future-valid session targets use the first relevant level encountered in the expected price direction; equal Asia/London prices merge into one unique target, treated as final Take Profit in the reviewed scenario without an intermediate Break-Even event. When no relevant session target remains future-valid before the operational scenario, the structural fallback is partially defined: sell candidates include relevant unmitigated support at validated 1H/4H HL or LL and Previous Day Low; buy candidates include relevant unmitigated resistance at validated 1H/4H LH or HH and Previous Day High. A structural swing becomes validated only after its causal formally closed body break beyond the prior opposite structural extreme; wick-only penetration or an open candle is insufficient, and the point cannot be used as validated before that close AsOfUtc. Structural support/resistance is body-marked rather than defined by an isolated long wick. In reviewed paths, 1H may be the first target or management level and a farther, structurally stronger 4H may be final or extended; this is not a universal hierarchy. That fallback does not rescue an originally imagined scenario after a valid post-08:30 liquidity take. Initial candidate-turn detection, exact candle/body selection and coordinate, body-zone reduction, OHLC mitigation test, PDH/PDL ranking, ties, general final-target hierarchy, and universal full-exit behavior remain unresolved or human-validated. The selected target is an absolute price level whose timeframe-independent quote touch, including wick contact in candle observations, requires no body close, candle close, or tolerance."),
