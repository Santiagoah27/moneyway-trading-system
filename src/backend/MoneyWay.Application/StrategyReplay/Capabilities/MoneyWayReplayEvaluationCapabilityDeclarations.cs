...
public static class MoneyWayReplayEvaluationCapabilityDeclarations
{
    ...
    [
        ...
        Blocked("moneyway-nasdaq", "nasdaq-0.1.0-draft", "NQ-TP-001", "Session target candidates, distinct first-encountered priority, and equal-target merge are source-defined. Structural fallback is partially defined: its candidate families include relevant unmitigated 1H/4H HL/LL support or Previous Day Low for sells and 1H/4H LH/HH resistance or Previous Day High for buys; body-based marking and the reviewed 1H-first/4H-extended relationship are source-supported, not universal. Deterministic structural-point identification, exact OHLC mitigation test, structural candle/body selection and coordinate, body-zone reduction, PDH/PDL cross-class ranking, and tie-breaking remain unresolved. General final Take Profit hierarchy outside the reviewed cases and universal full-exit behavior also remain unresolved.", NasdaqSource),
    ];
