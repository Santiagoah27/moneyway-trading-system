...
public static class MoneyWayReplayEvaluationCapabilityDeclarations
{
    ...
    [
        ...
        Blocked("moneyway-nasdaq", "nasdaq-0.1.0-draft", "NQ-TP-001", "Session target candidates, distinct first-encountered priority, and equal-target merge are source-defined. Structural fallback is partially defined: its candidate families include relevant unmitigated 1H/4H HL/LL support or Previous Day Low for sells and 1H/4H LH/HH resistance or Previous Day High for buys; the reviewed 1H-first/4H-extended relationship is source-supported, not universal. Candidate-HL selection and its body anchor are partially defined: within a human-delimited correction, preliminary or intermediate lows are discarded and the deepest low forming the base of the impulse later closing above the prior HH is the candidate; one- or two-candle pauses inside that impulse do not create another HL. Its selected-turn reference is the lowest Open or Close among its candle bodies, not an isolated wick, and it is usable only from the causal confirming close AsOfUtc. Candidate-LH selection remains unresolved. Exact correction and turn boundaries or segmentation, equal-coordinate body tie-breaking, other structural-point selection and coordinates, pivot/lookback rules if required, exact OHLC mitigation test, PDH/PDL cross-class ranking, and ties or coincidences remain unresolved. General final Take Profit hierarchy outside the reviewed cases and universal full-exit behavior also remain unresolved.", NasdaqSource),
    ];
