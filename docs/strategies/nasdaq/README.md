...
- Bullish correction start/end and candidate-HL price selection are partially defined; bearish prior-LL origin, causal LH validation, complex candidate-LH selection and highest-high replacement are confirmed. The bearish correction window remains partially defined; structural LH price, doji/gap handling, exact candle inclusivity, scan participation, turn membership and body anchor remain non-deterministic. The sell Stop Loss highest-wick anchor is separate from structural-target coordinates.
