...
- Bullish correction start/end and candidate-HL price selection are partially defined; doji/gap handling, exact candle inclusivity, turn membership, candidate-LH selection and structural-point identity remain unresolved.
