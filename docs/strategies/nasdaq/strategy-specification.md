...
| `STRUCTURAL_CANDIDATE_DETECTION` | `PARTIALLY_DEFINED` | Bullish candidate-HL window/price plus bearish causal validation, highest-candidate identity and selected-turn LH coordinate are materially narrowed; edge boundaries and bootstrap remain non-reproducible. |
