...
|---|---|---|
| Sell fallback candidates: relevant unmitigated support at a validated 1H/4H HL or LL | `CONFIRMED` | Candidate classes only; detection remains human-validated. |
| Buy fallback candidates: relevant unmitigated resistance at a validated 1H/4H LH or HH | `CONFIRMED` | Candidate classes only; detection remains human-validated. |
...
| HL/LL/LH/HH detection and validation algorithm | `UNRESOLVED` | No pivot, lookback or geometry may be inferred. |
