...
| `CANDIDATE_HL_SELECTION` | `PARTIALLY_DEFINED` | Deepest-low replacement and bullish reset/invalidation candle membership are confirmed; gaps, remaining inclusivity, tie identity and bootstrap still prevent a complete detector. |
...
| `BULLISH_CORRECTION_WINDOW` | `PARTIALLY_DEFINED` | In-range continuity, strict new-High reset, same-candle bearish restart membership and prior-HL invalidation-candle exclusion are confirmed; near-doji, gaps, remaining inclusivity, bootstrap and bearish symmetry remain unresolved. |
...
| `TURN_MEMBERSHIP_SEGMENTATION` | `PARTIALLY_DEFINED` | Bullish in-range continuity, same-candle bearish reset inclusion and invalidation-candle exclusion are confirmed; remaining bullish edge cases and independently evidenced bearish segmentation remain unresolved. |
...
| `STRUCTURAL_CANDIDATE_DETECTION` | `PARTIALLY_DEFINED` | Bullish in-range and terminal membership, color/doji continuity, new-High reset and prior-HL body-close invalidation join the confirmed candidate and causal-validation rules; near-doji, gaps, remaining inclusivity, bearish terminal symmetry and bootstrap remain non-reproducible. |
