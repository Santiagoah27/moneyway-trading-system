...
public sealed class MoneyWayNasdaqStrategyDefinitionTests
{
    ...
    public void FourHourContextMetadataMatchesAuditedSpecification()
    {
        ...
        Assert.Contains("Candidate-HL selection is partially defined", context.Description, StringComparison.Ordinal);
        Assert.Contains("preliminary or intermediate lows are discarded", context.Description, StringComparison.Ordinal);
        Assert.Contains("deepest low that forms the base of the impulse", context.Description, StringComparison.Ordinal);
        ...
        Assert.Contains("lowest Open or Close among its candle bodies", context.Description, StringComparison.Ordinal);
        ...
        Assert.Contains("Candidate-LH selection remains unresolved", context.Description, StringComparison.Ordinal);
        Assert.Contains("a supplied candidate high becomes a validated LH", context.Description, StringComparison.Ordinal);
        Assert.Contains("body close below the prior LL", context.Description, StringComparison.Ordinal);
        ...
        Assert.Contains("wick-only penetration and an open candle do not confirm structure", context.Description, StringComparison.Ordinal);
        Assert.Contains("Breakout, Wickfill, or Fakeout using OR", context.Description, StringComparison.Ordinal);
        Assert.Contains("reproducible correction and turn segmentation", context.Description, StringComparison.Ordinal);
        Assert.Contains("equal-coordinate body tie-breaking", context.Description, StringComparison.Ordinal);
    ...
    public void ReverifiedConceptsRemainExplicitWithoutClaimingDeterministicGeometry()
    {
        ...
        Assert.Contains("Candidate-HL selection is partially defined", structuralLiquidity.Description, StringComparison.Ordinal);
        Assert.Contains("preliminary or intermediate lows are discarded", structuralLiquidity.Description, StringComparison.Ordinal);
        Assert.Contains("deepest low that forms the base of the impulse", structuralLiquidity.Description, StringComparison.Ordinal);
        ...
        Assert.Contains("lowest Open or Close among its candle bodies", structuralLiquidity.Description, StringComparison.Ordinal);
        ...
        Assert.Contains("Candidate-LH selection remains unresolved", structuralLiquidity.Description, StringComparison.Ordinal);
        Assert.Contains("New HH/LL likewise require that closed body", structuralLiquidity.Description, StringComparison.Ordinal);
        Assert.Contains("Wick-only penetration or an open candle does not confirm structure", structuralLiquidity.Description, StringComparison.Ordinal);
        ...
        Assert.Contains("Exact correction and turn boundaries", structuralLiquidity.Description, StringComparison.Ordinal);
        ...
        Assert.Contains("candidate-LH and other structural-point selection", structuralLiquidity.Description, StringComparison.Ordinal);
        Assert.Contains("OHLC mitigation semantics", structuralLiquidity.Description, StringComparison.Ordinal);
        Assert.Contains("equal-coordinate body tie-breaking", structuralLiquidity.Description, StringComparison.Ordinal);
        ...
        Assert.Contains("Candidate-HL selection and its body anchor are partially defined", target.Description, StringComparison.Ordinal);
        Assert.Contains("candidate is the deepest low that forms the base of the impulse", target.Description, StringComparison.Ordinal);
        Assert.Contains("preliminary or intermediate lows and one- or two-candle pauses", target.Description, StringComparison.Ordinal);
        Assert.Contains("lowest Open or Close among its candle bodies", target.Description, StringComparison.Ordinal);
        ...
        Assert.Contains("Candidate-LH selection remains unresolved", target.Description, StringComparison.Ordinal);
        Assert.Contains("Exact correction and turn boundaries", target.Description, StringComparison.Ordinal);
        ...
        Assert.Contains("exact candle/body selection beyond the selected HL turn", target.Description, StringComparison.Ordinal);
        Assert.Contains("equal-coordinate body tie-breaking", target.Description, StringComparison.Ordinal);
