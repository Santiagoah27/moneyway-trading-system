...
public sealed class MoneyWayNasdaqStrategyDefinitionTests
{
    ...
    public void FourHourContextMetadataMatchesAuditedSpecification()
    {
        ...
        Assert.Contains("candidate low becomes a validated HL retrospectively", context.Description, StringComparison.Ordinal);
        Assert.Contains("body close above the prior HH", context.Description, StringComparison.Ordinal);
        Assert.Contains("candidate high becomes a validated LH", context.Description, StringComparison.Ordinal);
        ...
        Assert.Contains("not confirmed before the causal close AsOfUtc", context.Description, StringComparison.Ordinal);
        Assert.Contains("Breakout, Wickfill, or Fakeout using OR", context.Description, StringComparison.Ordinal);
        Assert.Contains("Initial structural candidate/bootstrap selection", context.Description, StringComparison.Ordinal);
        Assert.Contains("retracement geometry", context.Description, StringComparison.Ordinal);
        Assert.Contains("exact body coordinate", context.Description, StringComparison.Ordinal);
    ...
    public void ReverifiedConceptsRemainExplicitWithoutClaimingDeterministicGeometry()
    {
        ...
        Assert.Contains("candidate HL/LH is validated only after its impulse produces a formally closed body", structuralLiquidity.Description, StringComparison.Ordinal);
        Assert.Contains("same structural timeframe", structuralLiquidity.Description, StringComparison.Ordinal);
        Assert.Contains("new HH/LL also requires that closed body", structuralLiquidity.Description, StringComparison.Ordinal);
        ...
        Assert.Contains("cannot be treated as validated before the causal close AsOfUtc", structuralLiquidity.Description, StringComparison.Ordinal);
        Assert.Contains("candle bodies", structuralLiquidity.Description, StringComparison.Ordinal);
        Assert.Contains("isolated long wick does not define a level by itself", structuralLiquidity.Description, StringComparison.Ordinal);
        ...
        Assert.Contains("Initial candidate-turn detection", structuralLiquidity.Description, StringComparison.Ordinal);
        ...
        Assert.Contains("candidate geometry", structuralLiquidity.Description, StringComparison.Ordinal);
        Assert.Contains("OHLC mitigation semantics", structuralLiquidity.Description, StringComparison.Ordinal);
        Assert.Contains("exact candle/body selection", structuralLiquidity.Description, StringComparison.Ordinal);
        Assert.Contains("body coordinate", structuralLiquidity.Description, StringComparison.Ordinal);
        ...
        Assert.Contains("body-marked", target.Description, StringComparison.Ordinal);
        Assert.Contains("isolated long wick", target.Description, StringComparison.Ordinal);
        ...
        Assert.Contains("structural swing becomes validated only after its causal formally closed body break", target.Description, StringComparison.Ordinal);
        Assert.Contains("wick-only penetration or an open candle is insufficient", target.Description, StringComparison.Ordinal);
        Assert.Contains("cannot be used as validated before that close AsOfUtc", target.Description, StringComparison.Ordinal);
        Assert.Contains("Initial candidate-turn detection", target.Description, StringComparison.Ordinal);
        ...
        Assert.Contains("exact candle/body selection and coordinate", target.Description, StringComparison.Ordinal);
