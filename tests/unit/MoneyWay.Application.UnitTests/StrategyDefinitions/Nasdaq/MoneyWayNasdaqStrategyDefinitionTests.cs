...
public sealed class MoneyWayNasdaqStrategyDefinitionTests
{
    ...
    public void FourHourContextMetadataMatchesAuditedSpecification()
    {
        ...
        Assert.Contains("confirming-candle scan participation", context.Description, StringComparison.Ordinal);
    ...
    public void ReverifiedConceptsRemainExplicitWithoutClaimingDeterministicGeometry()
    {
        ...
        Assert.Contains("confirming-candle scan participation", structuralLiquidity.Description, StringComparison.Ordinal);
        ...
        Assert.Contains("confirming-candle scan participation", target.Description, StringComparison.Ordinal);
