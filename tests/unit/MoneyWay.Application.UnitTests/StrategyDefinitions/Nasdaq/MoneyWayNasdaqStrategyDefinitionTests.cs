...
public sealed class MoneyWayNasdaqStrategyDefinitionTests
{
    ...
    public void FourHourContextMetadataMatchesAuditedSpecification()
    {
        ...
        Assert.Contains("doji/Close == Open, gaps, exact candle inclusivity, turn-segmentation cases", context.Description, StringComparison.Ordinal);
    ...
    public void ReverifiedConceptsRemainExplicitWithoutClaimingDeterministicGeometry()
    {
        ...
        Assert.Contains("doji/Close == Open, gaps, exact candle inclusivity, turn-segmentation cases", structuralLiquidity.Description, StringComparison.Ordinal);
        ...
        Assert.Contains("doji/Close == Open, gaps, exact candle inclusivity, turn-segmentation cases", target.Description, StringComparison.Ordinal);
