...
public sealed class MoneyWayNasdaqStrategyDefinitionTests
{
    ...
    public void ReverifiedConceptsRemainExplicitWithoutClaimingDeterministicGeometry()
    {
        ...
        Assert.Contains("human-validated 1H/4H HL or LL", structuralLiquidity.Description, StringComparison.Ordinal);
        Assert.Contains("Previous Day Low", structuralLiquidity.Description, StringComparison.Ordinal);
        Assert.Contains("human-validated 1H/4H LH or HH", structuralLiquidity.Description, StringComparison.Ordinal);
        ...
        Assert.Contains("1H/4H HL or LL support", target.Description, StringComparison.Ordinal);
        Assert.Contains("Previous Day Low", target.Description, StringComparison.Ordinal);
        Assert.Contains("1H/4H LH or HH resistance", target.Description, StringComparison.Ordinal);
        ...
        Assert.Contains("Exact structural-point detector", target.Description, StringComparison.Ordinal);
        Assert.Contains("OHLC mitigation test", target.Description, StringComparison.Ordinal);
        Assert.Contains("body coordinate", target.Description, StringComparison.Ordinal);
