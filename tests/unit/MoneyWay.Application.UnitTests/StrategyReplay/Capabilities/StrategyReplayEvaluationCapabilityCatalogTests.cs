...
public sealed class StrategyReplayEvaluationCapabilityCatalogTests
{
    ...
    public void NasdaqTakeProfitCapabilityReasonNamesOnlyCurrentSpecificationBlockers()
    {
        ...
        Assert.Contains("doji/Close == Open, gaps, a bullish candle that simultaneously produces a new low, exact LL-candle inclusivity, ambiguous start-boundary precedence, and exact turn membership", declaration.Reason, StringComparison.Ordinal);
