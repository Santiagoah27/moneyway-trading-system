...
public sealed class StrategyReplayEvaluationCapabilityCatalogTests
{
    ...
    public void NasdaqTakeProfitCapabilityReasonNamesOnlyCurrentSpecificationBlockers()
    {
        ...
        Assert.Contains("doji/Close == Open, gaps, exact LL-candle inclusivity, exact turn membership/segmentation cases and bullish-side bearish-body/new-high precedence", declaration.Reason, StringComparison.Ordinal);
